      ...
      <div className="container">
        <div className="footerGrid">
          ...
          <div className="footerCol">
            ...
            <Link href="/listings/heber-valley-house" className="footerLink">Midway House</Link>
          </div>
          ...
          <div className="footerCol">
            ...
            <a href="mailto:hello@roamstead-co.com" className="footerLink">info@roamstead-co.com</a>
